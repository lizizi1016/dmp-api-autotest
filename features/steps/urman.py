...
def step_impl(context, delta_minutes):
    ...
    resp = api_post(
        context, "urman_rule/add_backup_rule", {
...
''',
    ...
    api_request_post(
        context, "urman_rule/confirm_add_backup_rule", {
...
def step_impl(context):
    ...
    has_match = pyjq.first(
        '.data | any(."instance_id" == "{0}")'.format(mysql_id), resp)
    assert has_match
...
def step_impl(context):
    ...
    api_request_post(
        context, "urman_rule/confirm_remove_backup_rule", {
            "config-id": get_3pc_config_id(resp),
            "is-commit": "true",
            "backup_rule_id": backup_rule_id,
        })
...
def step_impl(context):
    ...
    has_match = pyjq.first(
        '.data | any(."backup_rule_id" == "{0}")'.format(backup_rule_id), resp)
...
def step_impl(context):
    ...
    api_request_post(
        context, "urman_rule/recycle_backup_dir", {
            "instance_id": mysql_id,
...
def step_impl(context, delta_minutes):
    ...
    resp = api_post(
        context, "urman_rule/update_backup_rule", {
            "backup_rule_id": backup_rule_id,
            "instance_id": mysql["mysql_id"],
            "server_id": mysql["server_id"],
            "full_backup_cron": cron,
    ...
    api_request_post(
        context, "urman_rule/confirm_update_backup_rule", {
            "config-id": get_3pc_config_id(resp),
            "is-commit": "true",
            "backup_rule_id": backup_rule_id,
        })
